...
def main():
    ...
    #   [style image name]_[data format]_[num base channels]_[content weight]_[style weight]
    ...
    folder_name = style_image_str + "-" + options.data_format + "_nbc" + str(options.num_base_channels
                                    ) + "_bs" + str(options.batch_size) + "_" + content_weight_str + "_" + style_weight_str
