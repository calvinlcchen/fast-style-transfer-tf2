## Mark Yang - Data format to support NCHW (channel format)
Trying to make data format from NHWC (default in Tensorflow) to NCHW (default in PyTorch and ONNX).  So the resulted graph in ONNX is NCHW friendly.
