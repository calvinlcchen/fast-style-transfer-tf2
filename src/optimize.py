...
def optimize(content_targets, style_target, content_weight, style_weight,
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'), tf.compat.v1.Session() as sess:
        ...
        for layer in STYLE_LAYERS:
            ...
            #print ("style layer in VGG : %s " % (layer)) #clc, trace layer for style image
            #print (style_features[layer])  #clc, print style features - 2019-07-20
    ...
    with tf.Graph().as_default(), tf.compat.v1.Session() as sess:
        ...
        #print ("content layer in VGG : %s " % (CONTENT_LAYER)) #clc, trace layer for content image
        #print (content_features[CONTENT_LAYER])  #clc, print content features - 2019-07-20
        ...
        if slow:
            ...
            if data_format == 'NHWC':
                ...
                X_content_nchw = tf.transpose(a=x_content,perm=[0,3,1,2])
        ...
        for epoch in range(epochs):
            ...
            while iterations * batch_size < num_examples:
                ...
                feed_dict = {
                   X_content:X_batch   #clc, get image from dataset - 2019-07-20
                }
                ...
                if debug:
                    print("iteration: %d, UID: %s, batch time: %s" % (iterations, uid, delta_time))  #clc, add iterations
